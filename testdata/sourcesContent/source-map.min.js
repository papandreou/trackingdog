      ...
      (n.encode = function(e) {
        ...
        (n.decode = function(e, n, r) {
          ...
          do {
            ...
            if (((a = i.decode(e.charCodeAt(n++))), -1 === a))
          ...
          for (
            ...
            if (';' === e.charAt(v)) l++, v++, (p = 0);
              ...
              for (
                ...
                _ > s && !this._charIsMappingSeparator(e, s);
                s++
              );
              if (((t = e.slice(v, s)), (o = C[t]))) v += t.length;
              else {
                for (o = []; s > v; )
                  c.decode(e, v, y), (u = y.value), (v = y.rest), o.push(u);
                if (2 === o.length)
          ...
          n.eachMapping(function(e) {
            if (null !== p) {
              if (!(c < e.generatedLine)) {
                var n = u[0],
                  r = n.substr(0, e.generatedColumn - g);
                return (
                  (u[0] = n.substr(e.generatedColumn - g)),
                  (g = e.generatedColumn),
                  o(p, r),
                  void (p = e)
                );
            ...
            if (g < e.generatedColumn) {
              ...
              a.add(n.substr(0, e.generatedColumn)),
                (u[0] = n.substr(e.generatedColumn)),
                (g = e.generatedColumn);
            }
            p = e;
          }, this),
          u.length > 0 && (p && o(p, l()), a.add(u.join(''))),
