  ...
  describe('while passing a stack trace on stdin', () => {
    it('should output a sourcemapped stacktrace', async () => {
      ...
      await expect(
        ...
        'to yield output',
        'ApiError: Closed\n' +
          'at <anonymous>                     mail-static.cdn-one.com/src/common/lib/Api.js:734                        \n' +
          'at M                               mail-static.cdn-one.com/node_modules/regenerator-runtime/runtime.js:114  \n' +
          'at _invoke                         mail-static.cdn-one.com/node_modules/regenerator-runtime/runtime.js:324  \n' +
          'at (anonymous function) [as next]  mail-static.cdn-one.com/node_modules/regenerator-runtime/runtime.js:162  \n' +
          'at r                               mail-static.cdn-one.com/package.json:2                                   \n' +
          'at                                 mail-static.cdn-one.com/package.json:2                                   '
      );
    });
  });
