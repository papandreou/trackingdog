...
describe('cli', function() {
  it('should output the mapped source location', async function() {
    ...
    expect(
      ...
      'utf-8',
      'to equal',
      'file:///home/andreas/work/trackingdog/testdata/existingJavaScriptSourceMap/jquery-1.10.1.js:23:1\n'
    );
  });
  ...
  describe('with the --context switch', function() {
    it('should output a code snippet with a bit of context', async function() {
      ...
      expect(
        ...
        'utf-8',
        'to equal',
        'file:///home/andreas/work/trackingdog/testdata/existingJavaScriptSourceMap/jquery-1.10.1.js:109:16\n' +
          '\t\t\tjQuery.ready();\n' +
          '\t\t}\n' +
          '\t},\n' +
